...
video_players.forEach((video_player) => {
    const video_player_html = `
        ...
        <div class="settings">
            ...
            <div data-label="quality" hidden>
                ...
                <ul>
                    <li data-quality="fullhd" onclick="toggle()" >Full HD <span>VIP</span></li>
    ...
    qualities.forEach((event) => {
        ...
        insertAfterElement.insertAdjacentHTML('beforebegin', quality_html);
    });
            ...
            if (quality !== 'fullhd') {
                ...
                qualities.forEach((source) => {
                    if (source.getAttribute('size') == quality) {
                        ...
                        let video_source = source.getAttribute('src');
